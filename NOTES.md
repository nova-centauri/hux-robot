...
- Actuators: **temporary lock 2026-09-26** — 4× RobStride 02 (knee, roll), 2× RS00 (swing), 2× RS05 (wheel); source of truth `tools/living-drawings/actuators.js`. Not ordered; validate before buying one. Servo or stepper+belt stays the fallback.
