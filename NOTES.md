...
- [ ] **Research first** — study XRobots + Hattori + RAI Roadrunner per [`docs/research/`](docs/research/). Phases A–C before any print. No vendoring. RobotX is GPL3; do not relicense Hux (MIT) without Steve. Roadrunner is a lab RL demo, not a Hux stack.
...
- Research: [`docs/research/README.md`](docs/research/README.md) · shortlist [`docs/research/xrobots.md`](docs/research/xrobots.md) · Roadrunner [`docs/research/roadrunner.md`](docs/research/roadrunner.md) · plan [`docs/research/study-plan.md`](docs/research/study-plan.md)
- XRobots: https://github.com/XRobots · RobotX (GPL3): https://github.com/XRobots/RobotX
- Requirements: [`docs/requirements.md`](docs/requirements.md)
- Vision: [`docs/vision.md`](docs/vision.md)
- Inspiration: [Hattori STRIDE V2](https://www.alex-hattori.com/blog/wheeled-biped-v2) · [RAI Roadrunner](https://rai-inst.com/resources/videos/meet-roadrunner-a-bipedal-wheeled-robot-for-multi-modal-locomotion/) (watch alongside; not a build source)
