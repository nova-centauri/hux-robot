...
| Actuator shortlist (not ordered) | **RobStride 02** knees, **RobStride 00** hip roll + hip swing, **RobStride 05** wheels; one RS00 first on the Teensy. Classic CAN 1 Mbit on **two buses** (wheels + roll; knees + swing). Requires **≥24 V bus → 8S**. GIM8108-8 was the earlier yardstick. [`research/actuator-shortlist.md`](research/actuator-shortlist.md). Steve confirms; then it is a cart line. |
