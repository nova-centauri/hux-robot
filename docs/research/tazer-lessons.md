...
9. **Mechanical assembly orientation error.** A link on the wrong side made the robot too wide. Hux V1 width is **~14"** (R15). Use a fixture / checklist for left vs right (already a 2D + serviceability habit).
