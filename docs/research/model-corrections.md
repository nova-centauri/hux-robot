...
- **Collision and tire models remain approximations.** The drawing’s circular side silhouette is conservative under camber; projected clearance is not CAD clearance. The rigid tire hull retains about 3% artificial speed gain in the isolated roll trial and no carcass compliance. Visual mesh is still a flat-shoulder cylinder (`sim-view.js`); collision is a rounded convex, not a toroidal motorcycle crown. Twin honesty requires the crown (2026-09-25, [`../decisions.md`](../decisions.md)). The sandbox adds 0.12 kg of tubes to the drawing’s 6 kg lumps.
