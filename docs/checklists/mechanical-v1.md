...
Target: one side only — **carbon-tube spars** + printed / machined **end fittings**, linkage + spring stub, stroke / clearance toward a **~9.5"** riser, inside **~24" tall / ~10" wide**.
...
- [ ] Envelope: one wheel-leg that can share a **~10"** overall width and stay **≤ ~24"** tall at full extension.
