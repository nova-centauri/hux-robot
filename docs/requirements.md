...
| R12 | Knee / hip swing: **servo vs stepper+belt TBD** | **Do not lock either.** Both are open options. Size whichever we pick for one-leg plant load (R14). Serra's 40 kg-class servos are a data point, not a Hux SKU or a lean. Powerful / fast / reliable still required. No spend. |
...
- **Leg actuators undecided** (Steve 2026-09-20). Knee and hip swing: **servo vs stepper+belt TBD**. Document both; do not prefer one in the baseline. A concurrent packet locked stepper+belt — **that lock is lifted.** Size either class for R14. Wheels stay brushless (R6).
...
- **Knee / hip swing:** **servo vs stepper+belt TBD.** Both open. Size for one-leg (~2×) load. No SKU. No lean.
