...
| Mechanical V1 | First printable wheel-leg not started |
| Spend | None. No purchases until Steve approves. Prefer parts already on hand. |
...
```
docs/         requirements, vision, mechanical, electronics, software, checklists
