...
| Mechanical V1 | First wheel-leg is **Phase D** (after study + **2D layouts**). COTS structure, draft-friendly customs. Not started. |
...
- [Mechanical](docs/mechanical.md) — wheel-leg, linkages + springs, 9.5" stroke, fabrication rules (COTS / draft / wires / service / 2D-before-3D)
